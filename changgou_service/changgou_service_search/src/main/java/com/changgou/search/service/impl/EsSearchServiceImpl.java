...
public class EsSearchServiceImpl implements EsSearchService {
    ...
    public Map search(Map<String, String> searchMap) {
        ...
        //需求1: 根据输入框输入的商品关键词进行模糊搜索

        //构建组合查询查询条件对象BooleanQueryBuilder
        ...
        //需求3: 根据分类名称进行聚合,类似mysql的select category_name from tb_sku group by category_name
        // 需求3.1: 设置聚合分组名称
        ...
        //需求4: 根据规格进行聚合,类似于mysql的select spec tb_sku group by spec
        //需求4.1: 设置聚合分组名称
        ...
        //需求6: 根据品牌名称分类进行精确搜索, 类似于mysql的select * from tb_sku where category_name='老花镜'
        ...
        //需求7: 根据规格名称进行精确搜索类似于mysql的select * from tb_sku where spec_color='红色'
...
//            }
        ...
        searchResult.put("totalPage",search.getTotalPages());//搜索结果总也书,如果没有做分页配置那么此处默认是1页
