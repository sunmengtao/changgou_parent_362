...
public class OrderController {
    ...
    * 订单结算页地址
    * */
    private static final String READY_URL = "http://cart.changgou.com:8001/api/worder/ready";
    ...
    public String ready(Model model) {
        ...
        if (cartMap.size() == 0 || cartMap.get("orderItemList")==null || cartMap.get("orderItemList")==null || cartMap.get("totalPrice")==null) {
    ...
    public String submit(Order order){
        boolean submit = orderFeign.submit(order);
        if (submit){
